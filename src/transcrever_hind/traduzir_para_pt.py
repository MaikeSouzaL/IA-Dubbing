...
IN_ARQ = pipeline_file("transcricao.json")
OUT_ARQ = work_file("transcricao_pt.json")
...
ret = subprocess.run([sys.executable, str(ROOT / "scripts" / "extrair_frases_pt.py")], check=False, encoding='utf-8', errors='replace')
if ret.returncode != 0:
