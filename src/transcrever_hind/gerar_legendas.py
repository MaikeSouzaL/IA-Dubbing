...
from project_paths import output_file, pipeline_file, video_original_file
...
if __name__ == "__main__":
    ...
    frases_json = pipeline_file("frases_pt.json")
    
    # Gera legendas em português (traduzido)
    srt_pt = str(output_file(f"{base}_pt.srt"))
    ...
    srt_original = str(output_file(f"{base}_original.srt"))
